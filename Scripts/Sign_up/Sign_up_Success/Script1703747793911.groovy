...
WebUI.setText(findTestObject('Signup/input_Username_sign-username'), 'Testing15')

WebUI.setEncryptedText(findTestObject('Signup/input_Password_sign-password'), '/5S6MFFLcE4ZOg6V2jhgMg==')
